...
const en = {
  ...
  "brand.metaDescription":
    "Line Check (对词间) is your interview coach. Paste resume + job description, get speakable answers in English or Chinese, then practice out loud until they feel natural.",
  ...
  "home.preparingAudioPct": "Preparing voice… {n}%",
  "home.preparingAudioClip": "Preparing {clip}/{clips} · {n}%",
  "home.preparingAudioCached": "Loading saved voice…",
  ...
  "home.flash.noProvider":
    "All AI providers are off. Enable Gemini, DeepSeek, and/or Antigravity in Settings.",
  ...
  "doc.urlLabel": "Job posting URL",
  "doc.pasteLabel": "Paste document text",
  "doc.fileLabel": "Upload document file",
  ...
  "qa.emptyCta": "Build My Questions",
  ...
  "qa.selectOne": "Select question {n}",
  "qa.deselectOne": "Deselect question {n}",
  "qa.expandQuestion": "Question {n}",
  "qa.playing": "Playing",
  ...
  "settings.previewVoiceQ": "Hear interviewer voice",
  "settings.previewVoiceA": "Hear your voice",
  "settings.voiceHint":
...
const zh = {
  ...
  "brand.metaDescription":
    "对词间（Line Check）是你的面试教练。粘贴简历和职位描述，生成可口述的中英文回答，再大声练到自然顺口。",
  ...
  "home.preparingAudioPct": "正在准备语音… {n}%",
  "home.preparingAudioClip": "准备中 {clip}/{clips} · {n}%",
  "home.preparingAudioCached": "正在加载已缓存语音…",
  ...
  "home.flash.noProvider":
    "所有 AI 线路都关着。请在设置里开启 Gemini、DeepSeek 和／或 Antigravity。",
  ...
  "doc.extract": "提取文字",
  "doc.urlLabel": "职位链接",
  "doc.pasteLabel": "粘贴文档文字",
  "doc.fileLabel": "上传文档文件",
  "doc.fetching": "正在打开链接…",
  "doc.reading": "正在读你的文件…",
  ...
  "qa.selectAll": "全选",
  "qa.deselectAll": "取消全选",
  "qa.selectOne": "选择第 {n} 题",
  "qa.deselectOne": "取消选择第 {n} 题",
  "qa.expandQuestion": "第 {n} 题",
  "qa.playing": "播放中",
  ...
  "settings.previewVoiceQ": "试听面试官音色",
  "settings.previewVoiceA": "试听你的音色",
