...
const en = {
  ...
  "install.cta": "Add to Home",
  "install.dismiss": "Not now",
  "install.hintAndroid":
    "Install {brand} so your next rehearsal is one tap away.",
  "install.hintIos":
    "Tap Share → Add to Home Screen. Your coach stays on the phone with you.",
  ...
  "home.saveAudioHint":
    "One MP3 with every selected Q&A merged in order — take it offline and rehearse anywhere.",
  "home.exportingAudio": "Building your practice track…",
  "home.exportingAudioShort": "Saving…",
  "home.flash.audioSaved":
    "Nice — one practice MP3 with {n} Q&A is in Downloads. Listen, pause, try again.",
  "home.flash.audioFailed": "Couldn’t save the practice track. {detail}",
  ...
  "doc.drop": "Drop a file here, or tap to upload",
  "doc.extracting": "Reading…",
  "doc.formats": "PDF, Word, image, or text",
  ...
  "settings.nameHint": "Used when you say your name out loud. Wins over whatever we spot on the resume.",
  "settings.keyLoaded": "Key ready ({preview}… · {n} chars). Paste a new one anytime to replace it.",
  "settings.noKey": "No key yet — paste a Gemini API key so we can coach your answers.",
...
const zh = {
  ...
  "install.hintAndroid": "安装{brand}，下次练习一键打开。",
  "install.hintIos": "点分享 →「添加到主屏幕」，教练随时在你口袋里。",
  ...
  "home.saveAudioHint": "下载一个合并 MP3：所选问答按顺序串成一条，方便随时听、随时练。",
  "home.exportingAudio": "正在生成你的练习音频…",
  "home.exportingAudioShort": "保存中…",
  "home.flash.audioSaved":
    "很好——含 {n} 组问答的练习 MP3 已进下载文件夹。听一遍，再自己说一遍。",
  "home.flash.audioFailed": "练习音频没保存成功。{detail}",
  ...
  "doc.drop": "拖到这里，或点一下上传",
  "doc.extracting": "读取中…",
  "doc.formats": "支持 PDF、Word、图片或文本",
  "doc.orUrl": " · 或用上方链接",
  "doc.hidePaste": "收起粘贴",
  ...
  "settings.nameHint": "开口自我介绍时会用到。优先于简历里识别出的名字。",
  "settings.keyLoaded": "密钥已就绪（{preview}… · {n} 字符）。随时可粘贴新密钥覆盖。",
  "settings.noKey": "还没有密钥——粘贴 Gemini API 密钥，我们才能开始辅导。",
